...
/**
 * Metro DI module providing exposure reporting components for iOS.
 ...
 *
 * Dependencies:
 * - ExposureReportRepository from IosRepositoryModule (DataScope)
 * - InteractionHistoryUseCase from IosInteractionModule (DataScope)
 */
@ContributesTo(DataScope::class)
interface IosExposureReportModule {
    companion object {
        /**
        ...
        /**
         * Provides ExposureReportUseCase implementation for iOS.
