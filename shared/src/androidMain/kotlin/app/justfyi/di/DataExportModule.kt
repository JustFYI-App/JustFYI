...
/**
 * Metro DI module providing data export components.
 ...
 *
 * Dependencies:
 * - FirebaseProvider from FirebaseModule (DataScope)
 * - AppCoroutineDispatchers from CoreProviders (AppScope)
 */
@ContributesTo(DataScope::class)
interface DataExportModule {
    companion object {
        /**
         * Provides DataExportUseCase implementation.
